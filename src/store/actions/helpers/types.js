...
export const RESET_NEWBORN = 'reset_newborn';

export const FETCH_NEWBORN_GENERATIONS_REQUEST = 'fetch_newborn_generations_request';
export const FETCH_NEWBORN_GENERATIONS_SUCCESS = 'fetch_newborn_generations_success';
export const FETCH_NEWBORN_GENERATIONS_FAILURE = 'fetch_newborn_generations_failure';

export const FETCH_NEWBORN_GENERATION_REQUEST = 'fetch_newborn_generation_request';
export const FETCH_NEWBORN_GENERATION_SUCCESS = 'fetch_newborn_generation_success';
export const FETCH_NEWBORN_GENERATION_FAILURE = 'fetch_newborn_generation_failure';
export const RESET_NEWBORN_GENERATION = 'reset_newborn_generation';

export const FETCH_NEWBORN_EPISODES_REQUEST = 'fetch_newborn_episodes_request';
export const FETCH_NEWBORN_EPISODES_SUCCESS = 'fetch_newborn_episodes_success';
export const FETCH_NEWBORN_EPISODES_FAILURE = 'fetch_newborn_episodes_failure';

export const FETCH_NEWBORN_EPISODE_REQUEST = 'fetch_newborn_episode_request';
export const FETCH_NEWBORN_EPISODE_SUCCESS = 'fetch_newborn_episode_success';
